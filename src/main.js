...
function main() {
    ...
    for (var i = 0; i < given_orders_1.givenOrders.length; i++) {
        console.log();
        //input
        console.log();
        console.log();
        console.log("-----------------------------");
        var action = action_1.Action.createAction((given_orders_1.givenOrders[i]));
        ...
        orderBook.getOrders().forEach(function (order) { return console.log(order.toString()); });
        console.log();
        if (bestSharesToBuy) {
